...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      tabIndex={-1}
      className={cn(
        "absolute inset-y-0 z-20 hidden h-full w-1 bg-transparent transition-colors hover:bg-sidebar-accent md:flex",
        "group-data-[side=left]:left-0 group-data-[side=right]:right-0",
        "group-data-[variant=floating]:left-2 group-data-[variant=floating]:rounded-l-lg",
        "group-data-[variant=inset]:left-2 group-data-[variant=inset]:rounded-l-lg",
        "cursor-pointer",
        className
      )}
