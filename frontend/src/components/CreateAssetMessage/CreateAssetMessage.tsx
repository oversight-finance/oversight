            ...
            <div className="space-y-6">
                ...
                <div className="space-y-2">
                    <label htmlFor="assetSubtype" className="text-sm font-medium">
                        {dialogState.type === 'asset' ? 'Asset Category' : 'Account Category'}
                    </label>
                    <Select
    ...
    if (accounts.length === 3 && assets.length === 0) {
        return (
            <Dialog 
                ...
                onOpenChange={(open) => setDialogState(prev => ({ ...prev, isOpen: open, step: 'select' }))}
            >
                        ...
                        <DialogTitle className="text-xl">
                            {dialogState.step === 'select' 
                                ...
                                : dialogState.type === 'asset' 
                                    ...
                                    : `Add New ${accountTypeLabels[dialogState.subtype as AccountType]}`
                            }
                        </DialogTitle>
                    </DialogHeader>
                    <div className="px-1">
