            ...
            <div className="flex items-center flex-shrink-0">
              {user ? (
                <div className="flex items-center gap-6">
                  <Link href="/dashboard" className="text-sm font-medium text-gray-700 hover:text-gray-900 transition-colors hidden md:block">
                    Dashboard
                  </Link>
                  <Link href="/account" className="px-3 py-1.5 bg-gray-100 rounded-full text-sm font-medium text-gray-800 hover:bg-gray-200 transition-colors">
                    {displayName}
                  </Link>
